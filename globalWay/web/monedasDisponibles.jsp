<%-- 
    Document   : monedasDisponibles
    Created on : 19 jul 2023, 21:34:51
    Author     : JDEM_
--%>
      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th scope="col">Cambio a Dolar (1.00 USD)</th>
          </tr>
        </thead>
        <tbody>
            <% ArrayList<moneda> listaMonedas = (ArrayList) request.getSession().getAttribute("atributo");
